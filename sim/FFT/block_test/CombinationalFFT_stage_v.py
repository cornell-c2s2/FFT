...
#-------------------------------------------------------------------------
# CombinationalFFT_stage
#-------------------------------------------------------------------------

class CombinationalFFT_stage( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libCombinationalFFT_stage_v.so', os.path.getmtime( './libCombinationalFFT_stage_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libCombinationalFFT_stage_v.so')

    # increment instance count
    CombinationalFFT_stage.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "CombinationalFFT_stage.verilator1.vcd"
