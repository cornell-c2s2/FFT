...
class CombinationalFFT( Component ):
  ...
  def construct( s, *args, **kwargs ):
    ...
    s.recv = RecvIfcRTL( Bits512 )
    s.send = SendIfcRTL( Bits512 )
    ...
    s.s_DOT_recv_DOT_msg = Wire( mk_bits(512) )
    @update
    ...
    s.s_DOT_send_DOT_msg = Wire( mk_bits(512) )
    @update
    ...
    def comb_upblk():
      ...
      x[8] = int(s.s_DOT_recv_DOT_msg[256:288])
      x[9] = int(s.s_DOT_recv_DOT_msg[288:320])
      x[10] = int(s.s_DOT_recv_DOT_msg[320:352])
      x[11] = int(s.s_DOT_recv_DOT_msg[352:384])
      x[12] = int(s.s_DOT_recv_DOT_msg[384:416])
      x[13] = int(s.s_DOT_recv_DOT_msg[416:448])
      x[14] = int(s.s_DOT_recv_DOT_msg[448:480])
      x[15] = int(s.s_DOT_recv_DOT_msg[480:512])
      ...
      s.s_DOT_send_DOT_msg[256:288] @= x[8]
      s.s_DOT_send_DOT_msg[288:320] @= x[9]
      s.s_DOT_send_DOT_msg[320:352] @= x[10]
      s.s_DOT_send_DOT_msg[352:384] @= x[11]
      s.s_DOT_send_DOT_msg[384:416] @= x[12]
      s.s_DOT_send_DOT_msg[416:448] @= x[13]
      s.s_DOT_send_DOT_msg[448:480] @= x[14]
      s.s_DOT_send_DOT_msg[480:512] @= x[15]
